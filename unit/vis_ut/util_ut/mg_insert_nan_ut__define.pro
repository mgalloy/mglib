...
function mg_insert_nan_ut::test_gap
  compile_opt strictarr

  x = [0.0, 1.0, 3.0, 4.0, 5.0]
  y = 2.0 * x
  new_y = mg_insert_nan(x, y, new_x=new_x, gap=1.5, locations=locs)
...
function mg_insert_nan_ut::test_gap_and_basic
  compile_opt strictarr

  x = [0.0, 1.0, 3.0, 4.0, 5.0]
  y = 2.0 * x
  new_y = mg_insert_nan(x, y, [0.5, 3.5], new_x=new_x, gap=1.5, locations=locs)
