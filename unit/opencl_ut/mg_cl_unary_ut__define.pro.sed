...
function mg_cl_DEVICE_OP_ut::cleanup
  compile_opt strictarr

  ptr_free, self.valid_codes
  self->MGutCLUnaryTestCase::cleanup
...
function mg_cl_DEVICE_OP_ut::init, _extra=e
  ...
  if (~self->MGutCLUnaryTestCase::init(_extra=e)) then return, 0
...
pro mg_cl_DEVICE_OP_ut__define
  ...
  define = { mg_cl_DEVICE_OP_ut, inherits MGutCLUnaryTestCase, $
             f_tolerance: 0.0, $
             d_tolerance: 0.0D, $
             valid_codes: ptr_new() $
           }
