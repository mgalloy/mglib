 ...
 *   y0(x)  = R(x)  +   2 * log(x) * j0(x) / CEPHES_PI.
 ...
 * The function computed is  y0(x)  -  2 * log(x) * j0(x) / CEPHES_PI,
 * whose value at x = 0 is  2 * ( log(0.5) + EUL ) / CEPHES_PI
 * = 0.073804295108687225.
 */

/*
 * #define CEPHES_PI_4 .78539816339744830962
