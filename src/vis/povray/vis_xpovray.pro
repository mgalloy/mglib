...
;-
pro viswidpovray::resizeDraw, dims
  compile_opt strictarr
...
;       all events generated by the application 
;-
pro viswidpovray::handleEvent, event
  compile_opt strictarr
  ...
  case uname of
    ...
    'export': begin
        ...
        pov = obj_new('VISgrPovray', file_prefix=self.basename, $
    ...
    'run': begin
        ...
        tv, vis_povray(self.basename), true=1
      end
    'sizes': begin
...
; :Private:
;-
pro viswidpovray::createWidgets
  compile_opt strictarr
...
; :Private:
;-
pro viswidpovray::realizeWidgets
  compile_opt strictarr
...
; :Private:
;-
pro viswidpovray::startXManager
  compile_opt strictarr

  xmanager, 'xpovray', self.tlb, /no_block, $
            event_handler='vis_xpovray_event', $
            cleanup='vis_xpovray_cleanup'
end
...
;       size of graphics display
;-
function viswidpovray::init, view, model, dimensions=dimensions
  compile_opt strictarr
...
;       size of graphics display
;-
pro vis_xpovray, view, model=model, dimensions=dimensions
  compile_opt strictarr
  on_error, 2
  ...
  xpovray = obj_new('VISwidPOVRay', view, _model, dimensions=dimensions)
end


; main-level example program of using the VIS_XPOVRAY routine
...
vis_xpovray, view, dimensions=[600, 600]
