...
;-
pro visgranimation_timer, animation
...
;       view
;-
pro visgranimation::draw, picture
  compile_opt strictarr
  ...
  timer = obj_new('VIS_Timer', callback='visgranimation_timer', uvalue=self, $
...
;-
function visgranimation::init, destination=destination, animator=animator, $
...
;       root of object graphics hierarchy to render
;-
pro visgranimation__define
  compile_opt strictarr
  
  define = { VISgrAnimation, $
             destination: obj_new(), $
             animator: obj_new(), $
...
grow = obj_new('VISgrScaleAnimator', $
               target=model, $
               size=[2.0, 2.0, 2.0])

gotoStart = obj_new('VISgrTranslateAnimator', $
                    target=model, $
                    translation=[-0.75, -0.75, 0.])
                    
translateRight = obj_new('VISgrTranslateAnimator', $
                         target=model, $
                         translation=[1.5, 0., 0.], $
                         easing=obj_new('VISgrCircInOutEasing'))

parallel = obj_new('VISgrParallelAnimator')
parallel->add, gotoStart
parallel->add, translateRight

translateUp = obj_new('VISgrTranslateAnimator', $
                       target=model, $
                       translation=[0., 1.5, 0.], $
                       ;duration=2.0, $
                       easing=obj_new('VISgrCircOutEasing'))
                       
translateLeft = obj_new('VISgrTranslateAnimator', $
                        target=model, $
                        translation=[-1.5, 0., 0.], $
                        easing=obj_new('VISgrBounceOutEasing'))

translateDown = obj_new('VISgrTranslateAnimator', $
                        target=model, $
                        translation=[0., -1.5, 0.])
                                             
sequence = obj_new('VISgrSequenceAnimator')
sequence->add, [grow, parallel, translateUp, translateLeft, translateDown]

;win = obj_new('VISgrImageDestination', basename='im/test', dimensions=[600, 600], /show_frame)
win = obj_new('IDLgrWindow', dimensions=[600, 600])
animation = obj_new('VISgrAnimation', destination=win, animator=sequence)
