...
mg_psbegin, filename='pattern1.ps', xsize=5, ysize=5, /inches

green = mg_color('SeaGreen')
...
mg_psend
mg_convert, 'pattern1', max_dimensions=[500, 500], output=im
...
mg_psbegin, filename='pattern2.ps', xsize=5, ysize=5, /inches
...
mg_psend
mg_convert, 'pattern2', max_dimensions=[500, 500], output=im
